...
2. Create the plan in `./thoughts/shared/plan` folder
   - Filename: `thoughts/shared/plan/YYYY-MM-DD-ENG-XXXX-description.md`
...
3. Iterate with me addressing the feedback and asking clarifying questions I have and updating the document until we are satistfied
</SOP>
