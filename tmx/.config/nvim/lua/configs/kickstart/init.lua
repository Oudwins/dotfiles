...
-- [[ Diagnostic Config + Diagnostic keymaps ]]
...
--  Remove these because we are using vim-tmux-navigator
...
require('lazy').setup({
  ...
  --
  {
    ...
    -- Matches keywords if starting followed by : -> TODO, NOTE, HACK, FIX, WARNING
    ...
    require 'custom.plugins.vim_tmux',
